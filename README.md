...
GlobeFactor — Decoding the World, One Factor at a Time.

GlobeFactor is a modern news and analysis platform delivering in-depth coverage of global politics, conflicts & security, economy & trade, geopolitical analysis, and international relations. Configuration is driven by `contents/site-settings.json`.

## Features

- Articles, analysis, and expert commentary on world affairs
- Predefined categories (Global Politics, Conflicts & Security, Economy & Trade, Geopolitical Analysis, International Relations)
...
```bash
git clone https://github.com/BackSuit/GlobeFactor.git
cd GlobeFactor
```
